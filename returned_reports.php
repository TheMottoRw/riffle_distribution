        ...
        <table class="table table-hover">
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="GET" class="form-inline">
                ...
                <tr style="height: 50px;">
                    <th colspan="4"><label>From</label> <input type="date"
                                                               style="!important;height:40px;font-size: 20px"
                                                               class="form-control input-form col-lg-4" name="from"
                                                               placeholder="from"></th>
                    <th colspan="4"><label>To</label> <input type="date" style="!important;height: 40px;font-size: 20px"
                                                             class="form-control col-lg-4" name="to" placeholder="to">
                    </th>
                    <th colspan="2"><input type="submit" class="genric-btn primary circle"
