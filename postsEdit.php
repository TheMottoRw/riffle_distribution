...
$postObj = '';
if(count($apiPosts)>0) $postObj = $apiPosts[0];
?>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        if (isset($_POST['btnUpdate'])) {
                            $postData = array_merge(['cate' => 'update', 'district' => $_SESSION['sess_district']],$_GET, $_POST);
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input class="form-control" name="name" id="name" value="<?= $postObj['name'];?>">
                        </div>
                    </div>
                </div>
