...
<head>
    ...
    <title> Non returned - Report</title>
        ...
        <table class="table table-hover">
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="GET" class="form-inline">
                ...
                <tr style="height: 50px;">
                    <th colspan="3"><label>From</label> <input type="date"
                                                               style="!important;height:40px;font-size: 20px"
                                                               class="form-control input-form col-lg-4" name="from"
                                                               placeholder="from"></th>
                    <th colspan="3"><label>To</label> <input type="date" style="!important;height: 40px;font-size: 20px"
